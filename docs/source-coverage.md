...
| Report 13: research-agent construct validity and temporal fragility | [Katas 76–77](rag-research-evals.md#executed-report-and-citation-workshop) retain a complete compact report/corpus, explicit claim/citation spans, separate support/coverage denominators and old/new grades under an authored dated correction | Independently reviewed long professional reports; extraction completeness, compound claims, contradictions and synthesis validity; actual research-agent comparisons; authenticated correction authority and corpus provenance |
...
These are depth gaps in already-covered subjects, not reasons to discard the existing chapters. Paired slice reporting, mixed-trace error analysis, evidence packing, fixed-design sampling, synthetic rater analysis, deterministic judge-sensitivity controls and compact report/citation reassessment now have local worked artifacts. The compact report is not a completed long-report validation study. Next depth work should extend claim extraction and synthesis evidence to a substantial frozen report; keep external framework runs, actual reviewer studies and model-backed transfer scoped to their prerequisites. No single study closes the entire curriculum.
