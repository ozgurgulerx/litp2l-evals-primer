...
| Semantic stage in runner | Optional evaluator-owned stage and Responses adapter; calibration ingestion and Katas 18–20, 36–37; durable judge admission/unknown-cost reservations, stable paired invocation IDs, selected-cost aggregation and executed Katas 38–40 | Validated provider price bounds, agent/tool budgets, cancellation/reconciliation, release-gate integration and independently reviewed live calibration; no invoice cap or live semantic qualification claimed |
