...
| Semantic stage in runner | Optional evaluator-owned stage connected to single and paired runs; Katas 18–20 derive calibration counts; optional Responses adapter has offline SDK transport and paired replay tests, endpoint/usage validation and Katas 36–37 | Hard campaign spend/deadline controls, total evaluation-cost accounting and independently reviewed live calibration study; no live semantic qualification claimed |
