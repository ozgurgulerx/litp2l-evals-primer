...
The four-part reading order remains below. The [complete practice index](micro-katas.md#complete-practice-index) links all 103 numbered katas by topic; the [delivery map](primer-delivery-map.md) distinguishes implemented material from remaining work.
